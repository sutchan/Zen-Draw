// locales/types.ts v5.7.6 — 国际化类型定义（TranslationKey 联合类型，单一事实来源）
...
export type TranslationKey =
  ...
  | "densityComfortable" | "densityCompact"
  | "confetti" | "confettiDesc" | "reduceMotion" | "reduceMotionDesc"
  | "resetSettings" | "resetSettingsDesc"
  // 抽取模式
